...
public class TiledWorldLoader implements WorldLoader {
    ...
    private final Map<String, Map<Integer, Tile>> alreadyLoadedTiles = new HashMap<>();
        ...
        try {
            ...
            for (Element groupElement : getAllElementNode(map.getElementsByTagName("group"))) {
                ...
                for (Element layerElement : getAllElementNode(groupElement.getElementsByTagName("layer"))) {
                    ...
                    for (var state : loadTilesFromCSV(layerElement, tiles).entrySet()) {
    ...
    private Map<Cell, Tile> loadTilesFromCSV(Element csvElement, Map<Integer, Tile> tiles) {
        ...
        Map<Cell, Tile> result = new HashMap<>();
