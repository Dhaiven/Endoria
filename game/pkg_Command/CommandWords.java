...
public class CommandWords
{
    ...
    /**
     * Find the pkg_Command.CommandWord associated with a command word.
     * @param commandWord The word to look up.
     * @return The pkg_Command.Command correspondng to commandWord, or null
